...
import { DienstPageColumns } from "@/components/dienst-page-columns"
import { getServiceBySlug, getAllServiceSlugs, getServicePageImageSrc } from "@/lib/services"
...
export default async function DienstPage({ params }: PageProps) {
  ...
  const imageSrc = getServicePageImageSrc(slug)
    ...
    <main>
      ...
      <article className="bg-background min-h-screen py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <DienstPageColumns
            imageSrc={imageSrc}
            imageAlt={`Beeld bij de dienst ${service.title}`}
          >
